...
export const CopilotSettings = makeProviderSettingsSchema(
  {
    ...
    binaryPath: makeBinaryPathSetting("").pipe(
      Schema.annotateKey({
        title: "Binary path",
        description:
          "Optional path to a GitHub Copilot CLI binary. Leave blank to use the CLI bundled with the SDK.",
        providerSettingsForm: { placeholder: "Bundled CLI", clearWhenEmpty: "omit" },
      }),
    ),
    configDir: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        description: "Custom Copilot home for account-specific configuration and agents.",
